#https://github.com/rileynwong/lstm-jazz/blob/master/generate.py
...
def generate():
    ...
    with open('data_3/data/notes', 'rb') as f:
        notes = pickle.load(f)
...
def create_network(network_input, n_vocab):
    ...
    """
    model.add(Conv1D(32, kernel_size=7, activation='relu', padding='same', input_shape=(network_input.shape[1], network_input.shape[2])))
    model.add(Dropout(0.3))
    ...
    model.load_weights('weights-improvement-200-1.7297-bigger.hdf5')
...
def create_midi(prediction_output):
    ...
    midi_stream.write('midi', fp='output_song_1.mid')
